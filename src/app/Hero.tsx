...
function Hero() {
    return (
        <div className='w-screen'>
            <div className="flex bg-[#1E1919 sm:mt-[-350px] items-center justify-center">
            ...
            <div className='flex flex-col items-center justify-center w-screen'>
                <div className='sm:w-[650px] p-20 z-10 sm:h-[400px] bg-[#F8F9FB] shadow-custom-blue  sm:mt-[-350px] rounded-xl space-y-4'>
