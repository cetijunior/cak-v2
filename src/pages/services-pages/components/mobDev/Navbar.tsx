...
function Navbar() {
  ...
  return (
    <div className="sticky top-0 z-50 sm:px-14 shadow-custom-blue flex items-center justify-between bg-[#F8F9FB] sm:w-screen w-full">
      <div className="p-4" onClick={navigateHome}>
      ...
      >
        <ul className="flex h-full flex-col z-30 w-[300px] pl-5 space-y-12 items-start font-extralight justify-center text-white">
          <li
          ...
          <div
            ...
            className="flex flex-row items-center font-extralight space-x-4 cursor-pointer"
          >
          ...
          >
            <div className="flex flex-row pb-8 justify-between">
              <span className="text-3xl font-extralight">ENG</span>
              <img
                src="/arrow.png"
                alt="next"
        ...
        <div className="hidden md:hidden lg:flex flex-row items-center space-x-16 pr-16">
          ...
          <Link legacyBehavior href="/#services">
            <h1
              ...
              className="cursor-pointer hover:text-[#446AF2] transition-all duration-600 ease-in-out transform hover:scale-105 font-extralight text-xl z-20 h-100p relative"
            >
                  ...
                  {languageLinks.map((link, index) => (
                    <Link legacyBehavior key={index} href={link.href}>
                      <a className="flex p-2 items-center transition-all duration-300 ease-in-out transform hover:scale-105 space-x-3 bg-white  rounded-lg">
                        <div className="text-sm hover:font-semibold font-extralight text-md text-black">
                          {link.title}
                        </div>
                      </a>
                    </Link>
