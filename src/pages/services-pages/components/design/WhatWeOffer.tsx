  ...
  return (
    <div className="pt-10 sm:h-[35rem] flex flex-col items-center justify-center sm:gap-10 sm:space-x-10 sm:flex-row ">
      <div className="flex flex-col justify-center items-center sm:justify-start sm:items-start space-y-5">
        <h1 className="text-3xl px-5 pb-4">What we offer?</h1>
        <p className="px-5">
      ...
      <div className="flex flex-col md:flex-row gap-8 md:space-x-10">
        <div className="flex flex-col justify-end items-end">
          <div className="flex flex-col justify-end items-end">
            <div className="pt-8 flex flex-col space-y-11">
              <div className="ml-16 bg-white shadow-custom-blue rounded-3xl p-4">
                <h1>◉ User Experience Design (UX)</h1>
              </div>
              <div className="mr-8 bg-white shadow-custom-blue rounded-3xl p-4">
                <h1>◉ User Interface Design (UI)</h1>
              </div>
              <div className="ml-16 bg-white shadow-custom-blue rounded-3xl p-4 w-[11rem]">
                <h1>◉ Circular Design</h1>
              </div>
              <div className="bg-white shadow-custom-blue rounded-3xl p-4">
        ...
        <div className="flex flex-col justify-end items-end">
          <div className="flex flex-col space-y-11">
            ...
            <div className="mr-12 md:mb-4 bg-white shadow-custom-blue rounded-3xl p-4 w-[11rem]">
