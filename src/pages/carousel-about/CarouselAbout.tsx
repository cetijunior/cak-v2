...
function CarouselAbout() {
  ...
  const items = [
    ...
    { name: 'Shefqet CJ Lame', role: 'Co-Founder and FullStack Developer', img: '/cjPFP.png', className:'rounded-full w-[150px] h-[150px] ml-[0px] mt-[10px] sm:ml-[-85px] sm:mt-[50px] sm:w-[250px] sm:h-[250px]', text: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil nulla nobis quisquam cum libero praesentium iste doloribus nam, molestias nemo dignissimos. Sed, repudiandae est mollitia repellat sapiente sint totam ea?'},
    { name: 'Luars Qamo', role: 'Co-Founder and FullStack Developer', img: '/archiePFP.png', className:'rounded-full w-[200px] h-[200px] ml-[0px] mt-[-10px] sm:ml-[-85px] sm:mt-[15px] sm:mr-8 sm:w-[300px] sm:h-[300px]', text: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil nulla nobis quisquam cum libero praesentium iste doloribus nam, molestias nemo dignissimos. Sed, repudiandae est mollitia repellat sapiente sint totam ea?'}
  ];
  ...
  return (
    <div className={`carousel-container shadow-custom-blue ${backgroundClass} rounded-[39px]  mt-20 w-[290px] md:w-[400px] lg:w-[800px]`}>
