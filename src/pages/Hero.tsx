      ...
      <div className="flex flex-col items-center justify-center w-screen hover:p-30">
        <div className="w-[400px] sm:w-[650px] p-20 z-10 sm:h-[400px] bg-[#F8F9FB] shadow-custom-blue mt-[-40px] sm:mt-[-350px] rounded-xl space-y-4">
          ...
          <h3 className="text-center">
            Discover our range of services and find out how we can help you take
            your project to the next level. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Officiis, quasi, in cupiditate vero
            dicta eligendi maiores id ut quidem, illo molestiae alias quisquam
            magnam? Minima perferendis consectetur delectus culpa? Perspiciatis!
          </h3>
        </div>
        <button
          onClick={() => scrollToSection("contact")}
          className="bg-[#446AF2] z-10 text-white mt-[-20px] py-3 px-20 rounded-3xl"
        >
          Contact Us
        </button>
      </div>
