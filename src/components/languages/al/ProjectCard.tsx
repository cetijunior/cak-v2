  ...
  const cards = [
    {
      ...
      alt: "Klinika Estetike Website Template 3D Mockup",
      className:
    ...
    },
    {
      ...
      alt: "Kompania e Ndërtimit Website Template 3D Mockup",
      className:
    ...
    },
    {
      ...
      alt: "Dyqan Online Website Template 3D Mockup",
      className:
    ...
    },
    {
      ...
      alt: "Uebsajt per Restaurant Website Template 3D Mockup",
      className:
