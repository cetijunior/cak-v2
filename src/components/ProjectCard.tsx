...
function ProjectCard() {
    ...
    useEffect(() => {
        ...
        const timerIds = show.map((_, index) =>
            setTimeout(() => {
                setShow((prevShow) => {
                ...
                <div
                    ...
                    <div className={`flex flex-col
                        ...
                        <div className="px-6 pt-8 sm:pt-0 space-y-2 sm:space-y-4">
                            <p className="font-semibold text-3xl text-start sm:text-start">{card.text}</p>
                            <h1 className="text-sm text-start sm:text-start">{card.description}</h1>
                            <p className="font-semibold text-[15px] text-start sm:text-start">{card.tech}</p>
                        </div>
                    </div>
                </div>
            ))}
